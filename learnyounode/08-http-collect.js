...
provided to you as the first command-line argument. Collect 
all data from the server (not just the first "data" event) 
...
line should contain the complete String of characters sent by 
the server.
*/
